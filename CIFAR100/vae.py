...
parser = argparse.ArgumentParser(description='VAE CIFAR100 Example')
...
test_loader = torch.utils.data.DataLoader(
    datasets.CIFAR100('./data/cifar100', train=False, transform=transforms.ToTensor()),
    batch_size=args.batch_size, shuffle=True, **kwargs)
...
def train(epoch):
    ...
    torch.save(model.state_dict(), "parameters/cifar100_vae.pth")
